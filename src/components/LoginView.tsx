...
export function LoginView() {
  ...
  return (
    <div className="flex min-h-dvh items-center justify-center p-3 sm:p-4">
      <div className="grid w-full max-w-5xl overflow-hidden rounded-[24px] border border-[#e2d6c4] bg-[#fffdf8] shadow-2xl sm:rounded-[28px] lg:grid-cols-[1.1fr_0.9fr]">
        <div className="relative bg-ink p-6 text-white sm:p-10">
          ...
          <div className="relative flex h-full flex-col justify-between gap-6">
            <div>
              ...
              <h1 className="mt-4 text-3xl font-extrabold leading-tight sm:mt-6 sm:text-4xl">ANS Dashboard V3</h1>
              <p className="mt-3 max-w-sm text-sm leading-6 text-white/75 sm:mt-4">
                Dashboard operasional kelas, Sensei, dan QA untuk Aki No Sora × ILUSA.
              </p>
            </div>
            <p className="hidden text-xs text-white/50 lg:block">Masuk dengan akun resmi yang sudah diaktifkan.</p>
          </div>
        </div>
        <div className="p-5 sm:p-8">
          {!configured ? (
            <>
              ...
              <h2 className="mt-2 text-xl font-extrabold text-ink sm:text-2xl">Layanan belum terhubung</h2>
            ...
            <>
              ...
              <h2 className="mt-2 text-xl font-extrabold text-ink sm:text-2xl">Masuk dengan email</h2>
              <p className="mt-2 text-sm text-ink-soft">
